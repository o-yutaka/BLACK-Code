...
4. Normal `setup.ps1` reuses the verified parent through the existing resume/integrity path and continues F16 -> imatrix -> tensor map -> dry run -> IQ2_XXS -> local manifest.
